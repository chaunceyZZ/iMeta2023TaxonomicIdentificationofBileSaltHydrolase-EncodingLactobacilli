...
print(arg)
#arg=c("/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/2.1_Sig_KWU/P.Utest.Sig.data.txt","/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/bin/P-grouping.info"    , "/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/2.2_Sig_Volcano"   , "2"  )
dataFile <- arg[1];
groupFile <- arg[2];
outDir <- arg[3];
