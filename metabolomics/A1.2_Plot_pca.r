...
print(arg)
#arg <-c("/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/1.2_raw_Distance/N.modgower2.txt","/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/bin/N-grouping.info", "/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/1.3_raw_PCA"     , "2"  "/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/bin/N-color.txt")
...
pdf(paste(outDir,"/",SamID,".",MetID,".pca.pdf",sep=""),height=8,width=8);
...
### PCA.AERA
pdf(paste(outDir,"/",SamID,".",MetID,".pca.area.pdf",sep=""),height=8,width=8);
...
### PCA.point
pdf(paste(outDir,"/",SamID,".",MetID,".pca.point.pdf",sep=""),height=8,width=8);
par(mgp=c(2.5,1,0),mar=c(10,5,2,2),tcl=-0.2)
test <- data.frame(pc$loading[,1:2],group=groupname,col=ii,lab=ii)
p.info <- read.table(arg[5],header=T,row.names=1,comment.char = "")
p.info <- p.info[ii,]
