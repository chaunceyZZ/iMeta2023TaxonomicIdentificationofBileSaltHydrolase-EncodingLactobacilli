...
print(arg)
#arg=c("/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/2.1_Sig_KWU/N.Utest.Sig.data.txt", "/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/bin/N-grouping.info", "/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/2.9_Sig_Enrich" ,"2")
dataFile <- arg[1];
groupFile <- arg[2];
outDir <- arg[3];
...
write.table(Max.Group,file=paste(outDir,"/",SamID,".",MID,".",LID,".enriched.metabolite.dat",sep=""),quote = F,sep="\t",col.names=NA);
