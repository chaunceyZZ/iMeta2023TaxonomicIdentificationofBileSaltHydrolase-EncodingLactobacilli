...
print(arg)
## arg=c("/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/0.0_raw_data/P.data.txt","/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/bin/P-grouping.info", "/home/wmj/02_Metagenome/Metabolome/20190904_SZW/20190905/1.1_raw_Volcano" , "2"  )
dataFile <- arg[1];
groupFile <- arg[2];
outDir <- arg[3];
...
write.csv(stat,paste(outDir,"/",SamID,fc[1],"-",fc[2],".Volcano.csv",sep=""))
