...
print(arg)
#arg <- c( "/home/wmj/02_Metagenome/16s/20191012_CYM/Analysis/1_Abundance/Total.Genus.abundance.txt","/home/wmj/02_Metagenome/16s/20191012_CYM/bin/Total-color.txt"  ,"/home/wmj/02_Metagenome/16s/20191012_CYM/Analysis/1_Abundance"  ,"15" , "Control-Model","Control-Si" )
...
pdf(paste(SamID,".abundance.boxplot.between.pdf",sep=""),width=14,height=7);
...
#######Calculate the abundance of each type and boxplot the distribution
png(paste(SamID,".abundance.boxplot.between.png",sep=""),width=14*480/7,height=7*480/7, bg="transparent")
#par(mfrow=c(1,1),mar=c(30,3,3,3));
