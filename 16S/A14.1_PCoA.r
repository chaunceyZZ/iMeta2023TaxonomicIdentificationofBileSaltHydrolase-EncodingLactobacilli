...
print(arg)
#arg <- c( "/home/wmj/02_Metagenome/16s/20191012_CYM/14_Statistics/beta/Total/abund_jaccard_Total.gut.sub4W5.filter_4_noChimera_rmAlignFail.otu_table_even40000.txt", "/home/wmj/02_Metagenome/16s/20191012_CYM/bin/Total-color.txt"  ,"/home/wmj/02_Metagenome/16s/20191012_CYM/Analysis/18_raw_beta_PCoA/Total"  , "2" )
...
png(paste0(outDir,'/',ff,'.pcoa.no.circle.pdf'), bg="transparent")
plot(pc[,1],pc[,2],col = color,pch=shape,xlab=xlab,ylab=ylab,cex=0.9);
legend(x='topright',fill=color,bty='n',legend=Group,cex=1.2)

dev.off()

png(paste0(outDir,'/',ff,'.pcoa.circle.png'), bg="transparent")
plot(pc[,1],pc[,2],col = color,pch=shape,xlab=xlab,ylab=ylab,cex=0.9);
