...
for i in $(ls $Data/0_raw_data/*.fq); 
do
	fastqc -o $Data/QC_Raw -t 4 $i --extract ## 一般几个样品就用几个线程
done
perl $Data/bin/A5.1_Extract_QC_Raw.pl $Data'/0_raw_data/*.fq' $Data'/QC_Raw/*_fastqc/fastqc_data.txt' $Data/QC_Raw
...
perl $Data/bin/A5.2_Extract_QC_Merge.pl $Data'/1_combine_fq/*.fq' $Data'/QC_Merge/*_fastqc/fastqc_data.txt' $Data/QC_Merge
