...
print(arg)
#arg <- c("/home/wmj/02_Metagenome/16s/20191012_CYM/14_Statistics/beta/Total/spearman_approx_Total.gut.sub4W5.filter_4_noChimera_rmAlignFail.otu_table_even40000.txt", "/home/wmj/02_Metagenome/16s/20191012_CYM/bin/Total-color.txt" , "/home/wmj/02_Metagenome/16s/20191012_CYM/Analysis/8_OTUs_beta/Total"  , "2"  )
...
Beta.Group.mean <- unlist(Beta.Group.mean)
Beta.Group.sd <- unlist(Beta.Group.sd)
...
bar.pos <- barplot(Beta.Group.mean,border=NA,col=col.line[Groups],ylim=c(0,y.lim),ylab="",las=1,space=0.5,xaxt="n")
...
dev.off()
png(paste(outDir,"/",SamID,".",GID,".",MetID,".resample.otu.barplot.png",sep=""),width=4*480/7,height=4*480/7, bg="transparent")
#col.line=c("#DC143C","#4169E1","#2E8B57","#9932CC","#FF8C00","#FFFF00","#8B4513","#FF69B4","#808080")
col.line=G_cc
y.lim <- max(Beta.Group.mean+Beta.Group.sd)*1.3;
err.wid <- 0.1
...
pdf(paste(outDir,"/",SamID,".",GID,".",MetID,".resample.otu.boxplot.pdf",sep=""),width=4,height=4)
