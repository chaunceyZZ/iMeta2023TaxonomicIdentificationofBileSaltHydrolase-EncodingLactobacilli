...
# [ ! -d $Data/Analysis/21_raw_beta_PCA_abs ] && mkdir $Data/Analysis/21_raw_beta_PCA_abs;
...
[ ! -d $Data/Analysis/22_Sig_beta_PCA_abs2 ] && mkdir $Data/Analysis/22_Sig_beta_PCA_abs2;

for i in $(ls $Data/Analysis/12_Sig_Distance_abs2/*/*.txt)
do
	dir1=$(basename $i)
	dir2=`echo "$dir1" | cut -d . -f 1`
	[ ! -d $Data/Analysis/22_Sig_beta_PCA_abs2/$dir2 ] && mkdir $Data/Analysis/22_Sig_beta_PCA_abs2/$dir2;
	Rscript $Data/bin/A18.1_Sig_PCA.r  $i  $Data/Analysis/$dir2-color2.txt $Data/Analysis/22_Sig_beta_PCA_abs2/$dir2;	
done
